...
checklist =['MzkxNTE3MzQ4MQ==','Mzg5MjM0MDEwNw==','MzUzODY4NzE2OQ==','MzkyMjE3MzYxMg==','MzkxNjMwNDIzOA==','Mzg3NzUxMjc5Mg==','Mzg4NTcwODE1NA==','Mzk0ODIxODE4OQ==','Mzg2NjUyMjI1NA==','MzIzMDczODg4Mw==','Mzg5ODUyMzYzMQ==','MzU0NzI5Mjc4OQ==','Mzg5MDgxODAzMg==']#line:90
def ftime ():#line:93
...
def send (OOOOO0O000O0O0O0O ,title ='通知',url =None ):#line:108
    if not url :#line:109
        O00O0O0OOOOOOO0OO ={"msgtype":"text","text":{"content":f"{title}\n\n{OOOOO0O000O0O0O0O}\n\n本通知by：https://github.com/kxs2018/xiaoym\ntg频道：https://t.me/+uyR92pduL3RiNzc1\n通知时间：{ftime()}",}}#line:116
    else :#line:117
        O00O0O0OOOOOOO0OO ={"msgtype":"news","news":{"articles":[{"title":title ,"description":OOOOO0O000O0O0O0O ,"url":url ,"picurl":'https://i.ibb.co/7b0WtQH/17-32-15-2a67df71228c73f35ca47cabaa826f17-eb5ce7b1e.png'}]}}#line:122
...
def push (O0O0000O00OOO0OOO ,O0000OOOO0O0O0O0O ,O00O0O0O0O0O0OOOO ,uid =None ):#line:131
    ...
    OO0000OOOOOO0O00O ="<font size=5>[msg](url)</font>\n\n<font size=3>本通知by：https://github.com/kxs2018/xiaoym\n\n[点击加入作者tg频道](https://t.me/+uyR92pduL3RiNzc1)</font>".replace ('msg',O0O0000O00OOO0OOO ).replace ('url',O00O0O0O0O0O0OOOO )#line:135
    OOO00O0OO0OOOOO0O ={"appToken":appToken ,"content":OO0000OOOOOO0O00O ,"summary":O0000OOOO0O0O0O0O ,"contentType":3 ,"topicIds":topicids ,"uids":uids ,"url":O00O0O0O0O0O0OOOO ,"verifyPay":False }#line:145
...
def getmpinfo (OO0OO0O0000O0OO00 ):#line:153
    ...
    OO00OO0OO0OO0O000 =OO0OO0O000O000OO0 .xpath ('//div[@class="wx_follow_nickname"]/text()|//strong[@role="link"]/text()|//*[@href]/text()')#line:175
    if OO00OO0OO0OO0O000 :#line:176
        OO00OO0OO0OO0O000 =OO00OO0OO0OO0O000 [0 ].strip ()#line:177
    O00OOO0O0O0O00O00 =re .findall (r"user_name.DATA'\) : '(.*?)'",OO0OO00OO0O0OO0O0 .text )or OO0OO0O000O000OO0 .xpath ('//span[@class="profile_meta_value"]/text()')#line:179
...
class XYY :#line:200
    def __init__ (OO0O0OOO0O00O0O0O ,O00000OO0OOO00OO0 ):#line:201
        ...
        OO0O0OOO0O00O0O0O .sec .headers ={'User-Agent':'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/107.0.0.0 Safari/537.36 NetType/WIFI MicroMessenger/7.0.20.1781(0x6700143B) WindowsWechat(0x63090621) XWEB/8351 Flue','Content-Type':'application/x-www-form-urlencoded; charset=UTF-8','Cookie':f'ysmuid={OO0O0OOO0O00O0O0O.ysmuid};',}#line:210
    ...
    def getKey (O0OOO00O0000O0OOO ):#line:266
        ...
        O0OOO00O0000O0OOO .headers ={'Connection':'keep-alive','Accept':'application/json, text/javascript, */*; q=0.01','User-Agent':'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/107.0.0.0 Safari/537.36 NetType/WIFI MicroMessenger/7.0.20.1781(0x6700143B) WindowsWechat(0x63090621) XWEB/8351 Flue','Origin':f'https://{OOOOOO0OOOO000000}','Sec-Fetch-Site':'cross-site','Sec-Fetch-Mode':'cors','Sec-Fetch-Dest':'empty','Accept-Encoding':'gzip, deflate, br','Accept-Language':'zh-CN,zh',}#line:284
    def read (OO0000OOO0OOO00O0 ):#line:286
        ...
        while True :#line:290
            ...
            OO00OO000O00OOOOO =requests .get (OOOOOO0000OOO000O ,headers =OO0000OOO0OOO00O0 .headers ,params =OOOOOO0OO0O00O0OO )#line:292
                ...
                if 'mp.weixin'in OO00OOOOOO0OO0OO0 :#line:299
                    ...
                    if OOO00000OOO0O0OOO in checklist :#line:304
                        if sendable :#line:305
                            send (f"{O0O0OO0O0000O0OOO['text']}",title =f'{OO0000OOO0OOO00O0.name} 小阅阅过检测',url =OO00OOOOOO0OO0OO0 )#line:306
                        if pushable :#line:307
                            push (f'{OO0000OOO0OOO00O0.name}\n点击阅读检测文章\n{O0O0OO0O0000O0OOO["text"]}',f'{OO0000OOO0OOO00O0.name} 小阅阅过检测',OO00OOOOOO0OO0OO0 )#line:309
...
def get_ver ():#line:399
    ...
    O0OO0OO00000O0OOO ={"Accept":"text/html,application/xhtml+xml,application/xml;q=0.9,image/avif,image/webp,image/apng,*/*;q=0.8,application/signed-exchange;v=b3;q=0.7","User-Agent":"Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/115.0.0.0 Safari/537.36"}#line:403
    OO00O0000000O0OOO =requests .get ('https://ghproxy.com/https://raw.githubusercontent.com/kxs2018/xiaoym/main/ver.json',headers =O0OO0OO00000O0OOO ).json ()#line:405
