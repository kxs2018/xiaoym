...
ddz_config = {
    ...
    'ddzck': [],
    # ck设置，优先从环境变量中获取，[{'name':'xxx','ck':'xxx'},{'name':'xxx','ck':'xxx','uid':'UID_xxxxx','zfb_account':'18888888888','zfb_name':'狗蛋'}]name值随意，方便自己辨认即可。抓包cookie所有值，填入ck。uid是wxpusher一对一通知专属设置，其它情况不要填
}
"""点点赚设置完毕"""
...
mtz_config = {
    ...
    'mtzv2ck': '',
    # ck设置，建议填到环境变量或配置文件,多账号用&连接或创建多条变量。name=xxx;ck=share:xxxx&name=xxx;ck=share:xxxx;uid=UID_xxxx，微信和wxpusher群发不用填uid
