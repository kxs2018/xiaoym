...
"""提现黑名单设置"""
blacklist = []  # 黑名单中的账号不进行自动提现，填入ck中的name,['name1','name2']。只对钢镚生效，后续版本整合到钢镚专属设置

"""自定义ua"""
ua_list = [] # 微信浏览器ua，至少配置一个，手机端电脑端均可

"""企业微信设置"""
qwbotkey=''  # 脚本优先从环境变量获取，没有获取到再从此处获取。已实装脚本：元宝

"""wxpusher设置"""
pushconfig = {"appToken":"","topicids":[]} 
"""脚本优先从环境变量获取，没有获取到再从此处获取，"topicids":["123456"],一对一推送无需设置toppicids。已实装脚本：元宝"""
