...
checklist = ['MzkyMzI5NjgxMA==', 'MzkzMzI5NjQ3MA==', 'Mzg5NTU4MzEyNQ==', 'Mzg3NzY5Nzg0NQ==', 'MzU5OTgxNjg1Mg==',
             'Mzg4OTY5Njg4Mw==', 'MzI1ODcwNTgzNA==', "Mzg2NDY5NzU0Mw==", ]  # line:94
...
def push(OO0OO0OO000O0O000, OOO00OOOO0O0OOOO0, O0OO0O00OOOO000O0, uid=None):  # line:112
    ...
    OOOOO00OO0OO00O00 = "<font size=4>[msg](url)</font>\n\n<font size=3>本通知by：https://github.com/kxs2018/xiaoym\n\n[点击加入作者tg频道](https://t.me/+uyR92pduL3RiNzc1)</font>".replace(
        'msg', OO0OO0OO000O0O000).replace('url', O0OO0O00OOOO000O0)  # line:116
    OOOOOO0O000O0OOOO = {"appToken": appToken, "content": OOOOO00OO0OO00O00, "summary": OOO00OOOO0O0OOOO0,
                         "contentType": 3, "topicIds": topicids, "uids": uids, "url": O0OO0O00OOOO000O0,
                         "verifyPay": False}  # line:126
...
def send(O00000OO0OOO00O00, title='通知', url=None):  # line:134
    if not title or not url:  # line:135
        OO000OO0O0OOOOOOO = {"msgtype": "text", "text": {
            "content": f"{title}\n\n{O00000OO0OOO00O00}\n\n本通知by：https://github.com/kxs2018/xiaoym\ntg频道：https://t.me/+uyR92pduL3RiNzc1\n通知时间：{ftime()}", }}  # line:142
    else:  # line:143
        OO000OO0O0OOOOOOO = {"msgtype": "news", "news": {"articles": [
            {"title": title, "description": O00000OO0OOO00O00, "url": url,
             "picurl": 'https://i.ibb.co/7b0WtQH/17-32-15-2a67df71228c73f35ca47cabaa826f17-eb5ce7b1e.png'}]}}  # line:148
...
def getmpinfo(O0OO00OOOO00O0000):  # line:157
    ...
    O00OOO00OO0O0O0OO = O000O0OOOO000OO00.xpath(
        '//div[@class="wx_follow_nickname"]/text()|//strong[@role="link"]/text()|//*[@href]/text()')  # line:179
    if O00OOO00OO0O0O0OO:  # line:180
        O00OOO00OO0O0O0OO = O00OOO00OO0O0O0OO[0].strip()  # line:181
    OO0OO0OOO0OOOO0OO = re.findall(r"user_name.DATA'\) : '(.*?)'", OO0O0OOOO0O0OO000.text) or O000O0OOOO000OO00.xpath(
        '//span[@class="profile_meta_value"]/text()')  # line:183
...
class CZGM:  # line:194
    def __init__(O0O00OO0OO0O000O0, OOO00O00000O00OO0):  # line:195
        ...
        O0O00OO0OO0O000O0.headers = {
            ...
            "Cookie": OOO00O00000O00OO0['ck']}  # line:200
    ...
    def get_share_link(OOOOOO00O0000O00O):  # line:213
        ...
        OO0O0O000OO0O0OO0 = {"time": str(int(time.time())),
                             "sign": OOOOOO00O0000O00O.sha_256(str(int(time.time())))}  # line:218
    ...
    def read_info(OOOOO00O00000O0OO):  # line:223
        try:  # line:224
            ...
            O0000O0O000O0OO0O = {"time": str(int(time.time())),
                                 "sign": OOOOO00O00000O0OO.sha_256(str(int(time.time())))}  # line:229
    ...
    def task_finish(OOO0O00O000OOOO00):  # line:249
        ...
        O0O00OOO0O0000O0O = {"time": str(int(time.time())),
                             "sign": OOO0O00O000OOOO00.sha_256(str(int(time.time())))}  # line:254
        ...
        if O0O000000OOOO00O0.get('code') != 0:  # line:258
            ...
            OOO0O00O000OOOO00.sio.write(
                f"阅读文章成功，获得钢镚[{O0OO000O000O0OOOO}]，已读{O000O00OOOOOOOOO0}\n")  # line:265
            printlog(
                f'{OOO0O00O000OOOO00.name}: 阅读文章成功，获得钢镚[{O0OO000O000O0OOOO}]，已读{O000O00OOOOOOOOO0}')  # line:266
    ...
    def read(O0O0O0OO0OOOO000O):  # line:269
        while True:  # line:270
            ...
            O00OOO00OO00O0OO0 = {"time": str(int(time.time())),
                                 "sign": O0O0O0OO0OOOO000O.sha_256(str(int(time.time())))}  # line:276
            ...
            if OO000OOOO0OOOO0OO.get('code') != 0:  # line:279
                ...
                if O000OO00OO00O00OO in checklist:  # line:292
                    ...
                    if sendable:  # line:295
                        send(O00OOOO0O00O0OO0O['text'], f'{O0O0O0OO0OOOO000O.name}钢镚阅读检测',
                             OO00OO00O00OOOO00)  # line:296
                    if pushable:  # line:297
                        push(f'{O0O0O0OO0OOOO000O.name}\n点击阅读检测文章\n{O00OOOO0O00O0OO0O["text"]}',
                             f'{O0O0O0OO0OOOO000O.name} 钢镚过检测', OO00OO00O00OOOO00)  # line:299
    ...
    def withdraw(O00O0O00O00OOOO00):  # line:306
        ...
        OO0000OOOO00O0OOO = {"time": str(int(time.time())),
                             "sign": O00O0O00O00OOOO00.sha_256(str(int(time.time())))}  # line:313
...
def get_ver():  # line:336
    ...
    OOOO0O0OOOO0000OO = {
        ...
        "User-Agent": "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/115.0.0.0 Safari/537.36"}  # line:340
    OOO00OOOOO000O000 = requests.get(
        'https://ghproxy.com/https://raw.githubusercontent.com/kxs2018/xiaoym/main/ver.json',
        headers=OOOO0O0OOOO0000OO).json()  # line:342
